...
database = r"C:\Users\orira\PycharmProjects\pythonProject2\cyberprojgame\pythonsqlite.db"
...
def window():
    ...
    login_button = tk.Button(root, text="Login", command=lambda: trylogin(username_entry.get(), password_entry.get()))
    login_button.pack()

    # create the signup button
    signup_button = tk.Button(root, text="SignUp", command=lambda: create_user(username_entry.get(), password_entry.get()))
    signup_button.pack()
